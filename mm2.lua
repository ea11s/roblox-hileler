-- [[ Murder Mystery 2 SCRIPT BY RoWnn0 V9 - SILENT AIM & TRACERS ]] --
...
if game:GetService("CoreGui"):FindFirstChild("RoWnn0_V9") then
    game:GetService("CoreGui"):FindFirstChild("RoWnn0_V9"):Destroy()
end
...
title.Text = "💎 MM2 V9 BY RoWnn0 - SILENT AIM & TRACERS 💎"
            ...
            for _, p in pairs(Players:GetPlayers()) do
                if p ~= LP and p.Character and p.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if p.Backpack:FindFirstChild("Knife") or p.Character:FindFirstChild("Knife") then
                        ...
                        if vis then -- Eğer ekranda görünüyorsa (duvar arkası değilse)
...
AddToggle(combatTab, "Auto Kill (All)", function(v)
    _G.AK = v
    spawn(function()
        ...
        while _G.Tracers do wait(0.01)
            for _, p in pairs(Players:GetPlayers()) do
                if p ~= LP and p.Character and p.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    line.Name = "RoWnnLine"
                    line.Part = p.Character.HumanoidRootPart
                    ...
                    if hit then
                        line.Color3 = Color3.new(1, 0, 0) -- Duvar arkası KIRMIZI
                    else
                        line.Color3 = Color3.new(0, 1, 0) -- Önünde YEŞİL
                    end
                end
            end
        end
...
yt.MouseButton1Click:Connect(function() 
    ...
    game.StarterGui:SetCore("SendNotification", {Title = "RoWnn0", Text = "Link Copied! ✅"})
end)
